...
public class KLWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener{
...
//------------------- 视频相关功能 begin -------------------------------
     ...
     */
    @SuppressWarnings("unused")
    public KLWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView)
    {
     ...
     */
    @SuppressWarnings("unused")
    public KLWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public KLWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, KLWebView webView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
